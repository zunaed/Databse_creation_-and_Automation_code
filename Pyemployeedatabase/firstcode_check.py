...
#---------------------------------------------------------------------
        ...
        self.lblGender = Label(LeftFrame1, font=('arial',12,'bold'),text="Gender", bd=5,bg='gainsboro')
        ...
        self.lblMobile = Label(LeftFrame1, font=('arial',12,'bold'),text="Mobile No", bd=5, bg='gainsboro')
...
#==========================Widget===============================================================================================
        ...
        self.lblOtherPaymentDue = Label(LeftFrame2Left, font=('arial',12,'bold'),text="Other Payment", bd=7,bg='gainsboro',anchor='w', justify=LEFT)
        ...
        self.txtTaxablePay = Entry(RightFrame2c, font=('arial',12,'bold'),bd =5, width=12, justify='left', textvariable=TaxablePay)
        ...
        self.txtPensionablePay = Entry(RightFrame2c, font=('arial',12,'bold'),bd =5, width=12, justify='left', textvariable=PensionablePay)
        ...
        self.btnUpdate=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,width=8,text="Update",command= update).grid(row=0, column=3,padx=1)
        
        self.btnDelete=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,width=8,text="Delete",command= DeleteData).grid(row=0, column=4,padx=1)
        
        self.btnSearch=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,width=8,text="Search",command= searchData).grid(row=0, column=5,padx=1)
